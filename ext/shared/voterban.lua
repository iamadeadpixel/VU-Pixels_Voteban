...
Events:Subscribe('Player:Chat', function(player, recipientMask, message)
    ...
    if s_Parts[1] == '!voterban' then
        ...
        if not Config.voterban then
            ChatManager:SendMessage("voterban is disabled")
            print("voterban disabled")
            return
        end

        if Config.voterban then
		...
		Here start the countdown timer
                    ...
                    if trigger_timer == false then
                        ...
                        trigger_timer = true
                        voterban_function = true
                        print("Starting countdown for voterban on targetplayer:" .. targetplayer .. ":" .. s_message)
                        --
